 ...
 *
 */
public class PointWebSocket extends ViewComponent{

	   public static ImplDefinition DEFINITION = new ImplDefinition("pointWebSocket", "POINT_WEB_SOCKET", "graphic.html", null);
